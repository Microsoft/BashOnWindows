...
- **feature** – Denotes something that is not yet implemented.  The community should use our [User Voice page](https://wpdev.uservoice.com/forums/266908-command-prompt-console-bash-on-ubuntu-on-windo/category/161892-bash) for voting on which features everyone feels as the most important.  The team will take the [User Voice page](https://wpdev.uservoice.com/forums/266908-command-prompt-console-bash-on-ubuntu-on-windo/category/161892-bash) as input in deciding what to work on next.
